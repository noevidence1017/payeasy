        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead className="bg-white/5 border-b border-white/10">
              <tr>
                <th className="p-4 pl-6 text-[10px] text-dark-500 font-black uppercase tracking-widest" aria-sort="none">Participant</th>
                <th className="p-4 text-[10px] text-dark-500 font-black uppercase tracking-widest" aria-sort="none">Status</th>
                <th className="p-4 pr-6 text-[10px] text-dark-500 font-black uppercase tracking-widest text-right" aria-sort="none">On-Chain Contribution</th>
              </tr>
            </thead>
                  ...
                  <td className="p-4 pr-6 text-right">
                    <div className="flex items-center justify-end gap-6">
                      <div className="flex flex-col items-end">
                         <span className={`text-xl font-black tracking-tighter leading-none ${roommate.isPaid ? 'text-accent-400' : 'text-white'}`}>
                      ...
                      <div className={`p-2 rounded-xl border transition-all duration-1000 cubic-bezier(0.19, 1, 0.22, 1) ${
                         roommate.isPaid ? 'bg-accent-500/20 text-accent-400 border-accent-500/40 shadow-[0_0_20px_rgba(32,201,151,0.25)] scale-110 rotate-6' : 'bg-white/5 text-dark-700 border-white/5'
                      } group-hover:scale-125`}>
                         {roommate.isPaid ? <CheckCircle2 className="h-5 w-5" /> : <Clock className="h-5 w-5" />}
                      </div>
                    </div>
                  </td>
                </tr>
